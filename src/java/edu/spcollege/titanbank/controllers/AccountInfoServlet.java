...
public class AccountInfoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String action = request.getParameter("AccountType");
        if (action.equalsIgnoreCase("checking")){
        String httpforward = "/WEB-INF/CheckingAccount.jsp";
        RequestDispatcher dispatcher =
                    getServletContext().getRequestDispatcher(httpforward);
            dispatcher.forward(request, response);
        } else {
            String httpforward = "/WEB-INF/SavingsAccount.jsp";
        RequestDispatcher dispatcher =
                    getServletContext().getRequestDispatcher(httpforward);
            dispatcher.forward(request, response);
